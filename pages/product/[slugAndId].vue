...
const headTitle = computed(() =>
  seoStore.product?.title || 'Albaraka - Mahsulot sahifasi'
)

const headDescription = computed(() =>
  seoStore.product?.description || 'Mahsulot haqida batafsil maʼlumot'
)

const headKeywords = computed(() =>
  seoStore.product?.keywords || 'Mahsulot, online do‘kon, albaraka, texnika'
)
