        ...
        <div class="w-full max-w-6xl grid md:grid-cols-2 bg-white rounded-3xl overflow-hidden shadow-xl">
          ...
          <div class="p-12">
            <div class="max-w-md mx-auto relative">
              ...
              <h2 class="text-2xl font-bold text-gray-900 mb-2">Xush Kelibsiz</h2>
              <p class="text-gray-500 mb-8">Iltimos akkauntingizni login qiling</p>
              ...
              <form @submit.prevent="handleSubmit" class="space-y-6">
                ...
                <button
                  type="submit"
                  class="w-full h-[50px] cursor-pointer py-3 px-4 bg-[#feee00] hover:bg-[#feee00]/70 text-white rounded-lg transition-colors"
                >
                  <span v-if="loader">
...
const handleSubmit = async () => {
  try {
    loader.value = true
    errorMessage.value = null // Xatolikni har safar tozalash
    ...
    if (response.ok) {
      ...
      if (accessToken) {
        ...
        message.success('Muvaffaqiyatli login amalga oshirildi.')
      } else {
