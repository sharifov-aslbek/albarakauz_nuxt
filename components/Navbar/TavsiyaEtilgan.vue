<template>
    <div class="container">
        <div class="w-full">
          <Text :title="'Siz uchun tavsiya etilgan'" />
...
const err = ref(null);
  ...
  try {
    const res = await axios.get('https://api.albaraka.uz/api/uz/product/retrieve-by-marketId?PageSize=5&PageIndex=1&id=2  ');
